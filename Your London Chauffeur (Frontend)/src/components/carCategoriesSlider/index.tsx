      ...
      >
        ...
        <div className='carousel-inner'>
          {Object.keys(mapedCatageories).map((item, index) => {
            ...
            data-aos-duration="500"
            data-aos-once="false" className={styles.dollarWrapper}>
                          <div className={styles.dollarText}>Per Mile Rate</div>
                          <div className={styles.dollar}>
                            &pound; {catageory[0]?.rates?.perMile}
                          </div>
                        </div> */}
                          <div
                            data-aos='fade-up'
          ...
          {/* {cars?.map((car: Car, index: number) => (
            <div className={`carousel-item ${index === 0 && "active"}`} key={car._id}>
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <div data-aos="fade-up"
            data-aos-duration="500"
            data-aos-once="false" className={styles.ourRideHeading}>{car.class}</div>
                    <div data-aos="fade-up"
            data-aos-duration="500"
                    ...
                    <div className={styles.eclassCarWrapper}>
                      <div className="d-flex align-items-center gap-4">
                        <div>
                          <div data-aos="fade-up"
            data-aos-duration="500"
            data-aos-once="false" className={styles.checkIconWrapper}>
                            <Image
                              className={styles.checkIcon}
                              src={checkIcon}
                              alt="icon"
            ...
            data-aos-once="false" className={styles.checkIconWrapper}>
                            ...
                            />
                            <div className={styles.checkIconText}>
                              Free 60 mins waiting time for airport pickups, 15
                              mins for all others
                            </div>
                          </div>
                          <div data-aos="fade-up"
            ...
            data-aos-once="false" className={styles.checkIconWrapper}>
                      ...
                      <div className={styles.card}>
                        <div data-aos="fade-up"
            data-aos-duration="500"
            data-aos-once="false" className={styles.passengerIconWrapper}>
                          <Image
                            className={styles.passengerIcon}
                            src={passengerIcon}
                            alt="img"
            ...
            data-aos-once="false" className={styles.passengerIconWrapper}>
                          ...
                          />
                          <div className={styles.cardText}>
                            {car.features.suitCase} Suitcases
                          </div>
                        </div>
                        {car.features.electricOption && (
                          <div data-aos="fade-up"
            data-aos-duration="500"
            data-aos-once="false" className={styles.passengerIconWrapper}>
                            <Image
                        ...
                        {car.features.wifi && (
                          ...
                          data-aos-once="false" className={styles.passengerIconWrapper}>
                            <Image
                              ...
                              alt="img"
                            />
                            <div className={styles.cardText}>Onboard Wi-Fi</div>
                          </div>
                        )}
                      </div>
            ...
            data-aos-once="false" className={styles.dollarWrapper}>
                          ...
                          <div className={styles.dollar}>&pound; 150</div>
                        </div>
                        <Link href="/book-now">
                          <div data-aos="fade-up"
            data-aos-duration="500"
            data-aos-once="false" className={styles.buttonWrapper}>
                            <button className={styles.bookRideButton}>
                              Book This Ride
                            </button>
                          </div>
