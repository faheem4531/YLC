...
const Signin = () => {
  ...
  return (
    <div className={styles.heroSection}>
      <Head>
        <title>Sign In - Your London Chauffeur | Luxury Travel</title>
        {/* Open Grapg tags  */}
        <meta
          property="og:title"
          content="Sign In - Your London Chauffeur | Luxury Travel"
        />
        <meta
          property="og:description"
          content="Sign in to Your London Chauffeur account for access to luxury travel services. Experience premium chauffeur services for a comfortable and elegant journey."
        />
        <meta
          property="og:image"
          content="https://yourlondonchauffeur.co.uk/sign-in/images/og-image.jpg"
        />
        <meta
          property="og:url"
          content="https://yourlondonchauffeur.co.uk/sign-in"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <link
          rel="canonical"
          href="https://yourlondonchauffeur.co.uk/sign-in"
        />
        <NextSeo
          title="Sign In - Your London Chauffeur | Luxury Travel"
          description="Sign in to Your London Chauffeur account for access to luxury travel services. Experience premium chauffeur services for a comfortable and elegant journey."
          canonical="https://yourlondonchauffeur.co.uk/sign-in"
        />
      </Head>
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <div
              ...
              details.
              <h1 className={`d-inline ${styles.heroParagraph}`}> - Book Your London Chauffeur Online</h1>
            </div>
          </div>
          <div className="col-lg-6 d-flex justify-content-center flex-column">
            ...
            <div
              ...
              Already Registered?{" "}
              <Link href="/sign-up" className={styles.login}>
                Sign Up
              </Link>
            </div>
            <div
